...
const cubedSum3 = (array) => {
return array.reduce((acc, curr) => acc + curr**3, 0)
};
const sumOfCubes3 = cubedSum3(exampleArray);
console.log("sumOfCubes:", sumOfCubes3);
//------------------------------ OR --------------------------
...
const cubedSum2 = exampleArray.reduce((acc, curr) => acc + curr**3, 0);
console.log(cubedSum2);
...
console.log(["string"][0].split("bla") == ["string"][0]);  //true
console.log(["string"][0].split("str") == ["string"][0]); //false

const arrayOfWords = ["button", "breakfast", "border", "moboboro"];
const dictionary = (arr, str) => {
	return arr.filter(word => word.indexOf(str) === 0);
}
 
console.log(dictionary(arrayOfWords, "bo"));
// Notes:
